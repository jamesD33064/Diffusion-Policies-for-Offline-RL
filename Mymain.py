...
def load_dataset_from_minari(env_name: str) -> Dict[str, np.ndarray]:
    ...
    # ds = minari.load_dataset(env_name, download=True)
    ...
    for epi in ds.iterate_episodes():
        ...
        # 切分成 aligned transitions
        obs_list.append(o[:-1])       # 第一到倒數第二，共 T 筆
        next_obs_list.append(o[1:])   # 第二到最後，共 T 筆
...
if __name__ == "__main__":
    ...
    #     grad_norm=5.0,
    # )
    # agent.load_model("results/Walker2d-v5_exp_1_diffusion-ql_T-5_lr_decay_ms-offline_0", id=77)
